...
const data = [ //Fonte de dados JSON
	{
		"dia": 1,
		"valor": 22174.1664
	},
...
// Obter os valores do faturamento diário em um array
const valores = data.map(item => item.valor);

// Calcular o menor e o maior valor do array
...
console.log(menor.toFixed(2), maior.toFixed(2), media.toFixed(2));